...
|---|---|---|---|
| 0 | [`mx_urban_ecology_explorer.ipynb`](notebooks/mx_urban_ecology_explorer.ipynb) | Día 1 — Mapeo satelital de tu ciudad: de un punto en el mapa a imágenes reales de Sentinel-2 y datos censales del INEGI | [![Abrir en Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/rcavieses/sims_satelite_and_models/blob/main/notebooks/mx_urban_ecology_explorer.ipynb) |
